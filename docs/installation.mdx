...
docker run -p 6274:6274 mcpjam/mcp-inspector:latest

# Or run in the background
docker run -d -p 6274:6274 --name mcp-inspector mcpjam/mcp-inspector:latest
```

The application will be available at `http://localhost:6274`.
