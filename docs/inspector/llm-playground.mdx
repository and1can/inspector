...
<Note>
  GPT-5 models require organization verification. If you encounter access errors, visit [OpenAI Settings](https://platform.openai.com/settings/organization/general) and verify your organization. Access may take up to 15 minutes after verification.
</Note>
