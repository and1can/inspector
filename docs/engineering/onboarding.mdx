...
<Card title="OAuth Architecture Deep Dive" icon="lock" href="/engineering/oauth-architecture">
...
<Check>
  Ready to start contributing? Check out our [Contributing Guide](/inspector/contributing-guide) for next steps!
</Check>
